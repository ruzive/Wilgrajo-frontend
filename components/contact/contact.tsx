import backgroundImage from '@public/assets/images/Zimindo_Plaza.jpeg'
const ContactForm = () => {
  return (
    // <div className="grid-cols-4 sm:grid md:grid-cols-2 ">
    <div className="grid-cols-3 sm:grid-cols-2 2xl:grid-cols-3 grid-rows-auto gap-4 py-[100px] w-[90%] mx-auto">
      <div className="mx-3 mt-6 flex flex-col self-start rounded-lg bg-gradient-to-tr from-[#558b00]/60 to-[#fe3e0a]/60 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 sm:shrink-0 sm:grow sm:basis-0">
        <div className="p-6">
          <section className="mb-32">
            <div className="relative h-[300px] overflow-hidden bg-cover bg-[50%] bg-no-repeat" style={{ backgroundImage: `url(${backgroundImage})` }}>
            </div>
              ...
              <div className="block rounded-lg bg-[hsla(0,0%,100%,0.7)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,5%,0.7)] dark:shadow-black/20 md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px]">
                <div className="mb-12 grid gap-x-6 md:grid-cols-2 lg:grid-cols-4">
                  ...
                  <div className="mx-auto mb-6 text-center md:mb-0">
                    ...
                    <h6 className="font-medium">(+260)979-997 008</h6>
                  </div>
                </div>
                  ...
                  <form>
                    ...
                    <div className="mb-6 inline-block min-h-[1.5rem] justify-center pl-[1.5rem] md:flex">
                      <input
                        ...
                        type="checkbox" id="exampleInputCheck1" />
                      <label className="block text-neutral-500 font-normal text-sm" htmlFor="exampleInputCheck1">I accept the terms and conditions</label>
                    </div>
